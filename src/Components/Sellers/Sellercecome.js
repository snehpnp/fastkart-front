...
function Sellerbecome() {
          ...
          <div className="breadscrumb-contain">
            ...
            <nav>
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item active" aria-current="page">Become a vendor</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div className="col-xxl-4 order-lg-2">
          <div className="poster-box">
            <div className="poster-image">
              <img src="https://themes.pixelstrap.com/fastkart/assets/images/vendor-page/become-saller.svg" className="img-fluid" alt />
            </div>
          </div>
        </div>
  ...
  <section className="become-service section-b-space">
    <div className="container-fluid-lg">
  ...
  <section className="selling-section section-b-space">
    <div className="container-fluid-lg">
      ...
      <form>
        <div className="row">
          <div className="col-lg-6">
            <div className="mt-3">
              <div className="form-floating theme-form-floating-2 search-box">
                <input type="email" className="form-control" id="mail" placeholder="Email Id" />
          ...
          <div className="col-12">
            <button className="btn btn-md mt-3 theme-bg-color text-white">Start Selling</button>
          </div>
        </div>
      </form>
    </div>

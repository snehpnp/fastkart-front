          ...
          <div className="three-slider arrow-slider ratio_65">
            <div>
              <div className="offer-banner hover-effect">
                <img src="../assets/images/veg-3/value/1.png" className="img-fluid bg-img  lazyload" alt />
            ...
            <div>
              <div className="offer-banner hover-effect">
                <img src="../assets/images/veg-3/value/2.png" className="img-fluid bg-img  lazyload" alt />
                <div className="banner-detail">
            ...
            <div>
              <div className="offer-banner hover-effect">
                <img src="../assets/images/veg-3/value/3.png" className="img-fluid bg-img  lazyload" alt />
                <div className="banner-detail">
          ...
          <div className="three-slider-1 arrow-slider">
            <div>
              <div className="deal-box wow fadeInUp">
                <a href="shop-left-sidebar.html" className="category-image order-sm-2">
                  <img src="../assets/images/veg-3/cate1/1.png" className="img-fluid  lazyload" alt />
                </a>
            ...
            <div>
              <div className="deal-box wow fadeInUp" data-wow-delay="0.05s">
                <a href="shop-left-sidebar.html" className="category-image order-sm-2">
                  <img src="../assets/images/veg-3/cate1/2.png" className="img-fluid  lazyload" alt />
                </a>
                <div className="deal-detail order-sm-1">
                  <button className="buy-box btn theme-bg-color text-white btn-cart">
                    <i className="iconly-Buy icli m-0" />
            ...
            <div>
              <div className="deal-box wow fadeInUp" data-wow-delay="0.1s">
                <a href="shop-left-sidebar.html" className="category-image order-sm-2">
                  <img src="../assets/images/veg-3/cate1/3.png" className="img-fluid  lazyload" alt />
                </a>
                <div className="deal-detail order-sm-1">
                  <button className="buy-box btn theme-bg-color text-white btn-cart">
                    <i className="iconly-Buy icli m-0" />
            ...
            <div>
              <div className="deal-box wow fadeInUp" data-wow-delay="0.15s">
                <div className="category-image order-sm-2">
                  <img src="../assets/images/veg-3/cate1/1.png" className="img-fluid" alt />
                </div>
                <div className="deal-detail order-sm-1">
                  <button className="buy-box btn theme-bg-color text-white btn-cart">
                    <i className="iconly-Buy icli m-0" />
            ...
            <div className="col-xxl-2 col-lg-3 col-md-4 col-6">
              <div className="product-box-4">
                <div className="product-image">
                  ...
                  <a href="product-left-thumbnail.html">
                    <img src="../assets/images/veg-3/cate1/10.png" className="img-fluid" alt />
                  </a>
                  <ul className="option">
                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Quick View">
                      <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
            ...
            <div className="col-xxl-2 col-lg-3 col-md-4 col-6">
              <div className="product-box-4">
                <div className="product-image">
                  ...
                  <a href="product-left-thumbnail.html">
                    <img src="../assets/images/veg-3/cate1/14.png" className="img-fluid" alt />
                  </a>
                  <ul className="option">
                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Quick View">
                      <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
            ...
            <div className="col-xxl-2 col-lg-3 col-md-4 col-6">
              <div className="product-box-4">
                <div className="product-image">
                  ...
                  <a href="product-left-thumbnail.html">
                    <img src="../assets/images/veg-3/cate1/16.png" className="img-fluid" alt />
                  </a>
                  <ul className="option">
                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Quick View">
                      <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
      ...
      <div className="row gy-xl-0 gy-3">
        <div className="col-xl-6">
          <div className="banner-contain-3 hover-effect">
            <img src="../assets/images/veg-3/banner/1.png" className="bg-img img-fluid" alt />
                  ...
                  <div className="row gy-sm-4 gy-3">
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/1.png" className="img-fluid" alt />
                        </a>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/2.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/3.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                ...
                <div>
                  <div className="row gy-sm-4 gy-3">
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/4.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/5.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/6.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                ...
                <div>
                  <div className="row gy-sm-4 gy-3">
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/7.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/8.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 pb-1 wow fadeInUp" data-wow-delay="0.1s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/9.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                ...
                <div>
                  <div className="row gy-sm-4 gy-3">
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/10.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/11.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
                    ...
                    <div className="col-12">
                      <div className="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                        <a href="shop-left-sidebar.html" className="product-image">
                          <img src="../assets/images/veg-3/pro1/12.png" className="img-fluid" alt />
                        </a>
                        <div className="product-details">
                          <ul className="rating">
                            <li>
      ...
      <div className="row">
        <div className="col-12">
          <div className="banner-contain-3 section-b-space section-t-space hover-effect">
            <img src="../assets/images/veg-3/banner/3.png" className="img-fluid bg-img" alt />
      ...
      <div className="slider-3 arrow-slider">
          ...
          <div className="blog-box ratio_50">
            <div className="blog-box-image">
              <a href="blog-detail.html">
                <img src="../assets/images/veg-3/blog/1.jpg" className="img-fluid bg-img" alt />
              </a>
            </div>
        ...
        <div>
          <div className="blog-box ratio_50">
            <div className="blog-box-image">
              <a href="blog-detail.html">
                <img src="../assets/images/veg-3/blog/2.jpg" className="img-fluid bg-img" alt />
              </a>
            </div>
            <div className="blog-detail">
        ...
        <div>
          <div className="blog-box ratio_50">
            <div className="blog-box-image">
              <a href="blog-detail.html">
                <img src="../assets/images/veg-3/blog/3.jpg" className="img-fluid bg-img" alt />
              </a>
            </div>
            <div className="blog-detail">
              <label>Conversion rate optimization</label>
      ...
      <div className="row">
        <div className="col-12">
          <div className="newsletter-box hover-effect">
            <img src="../assets/images/veg-3/shape/background.png" className="img-fluid bg-img" alt />
            <div className="row">
              ...
              <div className="col-xxl-4 col-xl-5 d-xl-block d-none">
                <div className="shape-box">
                  <img src="../assets/images/veg-3/shape/basket.png" alt className="img-fluid image-1" />
                </div>
              </div>
            </div>
          </div>
